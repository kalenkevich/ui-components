...
exports["default"] = exports.AuthorizationService = void 0;
...
var makeAuthorizationService = function makeAuthorizationService(authUrl) {
  return new AuthorizationService(authUrl);
};

var Service = makeAuthorizationService("".concat(_settings["default"].AuthBackendUrl, "/graphql"));
exports.AuthorizationService = Service;
var _default = makeAuthorizationService;
