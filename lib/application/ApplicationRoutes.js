...
var _OrdersPage = _interopRequireDefault(require("../pages/OrdersPage"));

var _TendersPage = _interopRequireDefault(require("../pages/TendersPage"));

var _ContractorPortfolioPage = _interopRequireDefault(require("../pages/ContractorPortfolioPage"));
...
var Routes = function Routes() {
  return _react["default"].createElement(_reactRouterDom.Switch, null, _react["default"].createElement(_reactRouterDom.Route, {
    ...
    path: "/pages/orders",
    component: _OrdersPage["default"]
  }), _react["default"].createElement(_reactRouterDom.Route, {
    path: "/pages/tenders",
    component: _TendersPage["default"]
  }), _react["default"].createElement(_reactRouterDom.Route, {
    path: "/pages/contractor-portfolio",
    component: _ContractorPortfolioPage["default"]
