        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 2;
              _context.next = 5;
              return _AuthorizationService["default"].authorize();
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 2;
              _context2.next = 5;
              return _AuthorizationService["default"].signIn.apply(_AuthorizationService["default"], _args2);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 2;
              _context3.next = 5;
              return _AuthorizationService["default"].signUp.apply(_AuthorizationService["default"], _args3);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.prev = 2;
              _context4.next = 5;
              return _AuthorizationService["default"].signOut.apply(_AuthorizationService["default"], _args4);
