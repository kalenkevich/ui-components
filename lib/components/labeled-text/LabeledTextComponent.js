...
var LabeledText = function LabeledText(props) {
  ...
  var labelClasses = (0, _Utils.getClassName)([classes.label, reverse ? 'reverse' : '']);
  var contentClasses = (0, _Utils.getClassName)([classes.content, reverse ? 'reverse' : '']);
  ...
  if (reverse) {
    ...
    }, content), _react["default"].createElement(_label["default"], {
      value: label,
