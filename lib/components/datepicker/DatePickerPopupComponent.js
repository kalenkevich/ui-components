...
var DateSelectPopup = function DateSelectPopup(props) {
  ...
  var years = (0, _DateUtils.getYears)(selectedYear, _DateConstants.YEAR_STEP);
  var months = (0, _DateUtils.getMonths)(selectedYear, selectedMonth, _DateConstants.MONTH_STEP);
  var weeks = (0, _DateUtils.getWeeks)(selectedYear, selectedMonth);
  ...
  return _react["default"].createElement("div", {
    ...
    return _react["default"].createElement("div", {
      ...
      var dayClass = (0, _Utils.getClassName)([classes.day, day.value === selectedDay ? 'selected' : '', day.value === currentDay ? 'current' : '', day.date.getMonth() !== selectedMonth ? 'another-month' : '']);
