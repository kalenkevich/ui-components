...
var DatePicker = function DatePicker(props) {
  ...
  var formattedStartDate = (0, _Utils.getFormattedDate)(internalDate.startDate);
  var formattedEndDate = (0, _Utils.getFormattedDate)(internalDate.endDate);

  var onDateChangeClick = function onDateChangeClick(newDate, key) {
    setDate((0, _objectSpread3["default"])({}, internalDate, (0, _defineProperty2["default"])({}, key, newDate)));
  };
  ...
  var resultOptions = (0, _objectSpread3["default"])({}, options, {
    dates: (0, _toConsumableArray2["default"])((options || {}).dates || [])
  });
